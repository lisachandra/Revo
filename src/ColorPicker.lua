...
type props = Types.elementProps<Color3>
type styles = {
                    ...
                    [Roact.Children] = {
                                    ...
                                    [Roact.Children] = {
                                        Value = {
                                            ...
                                            BackgroundColor3 = Color3.fromRGB(
                                                (window.theme.elementColor.R * 255) + 13,
                                                (window.theme.elementColor.G * 255) + 13,
                                                (window.theme.elementColor.B * 255) + 13
                                            ),
                                        ...
                                        Name = { TextColor3 = window.theme.textColor },
                                    },
                                },
                        ...
                        Rainbow = {
                            [Roact.Children] = {
                                ...
                                Outline = { ImageColor3 = window.theme.schemeColor },
